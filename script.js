...
youtubeId: "YoHD9XEInc0" // Official Warner Bros trailer
},
{
title: "Joker",
year: "2019",
...
let currentMovie = null; // Track current movie

// Update Hero Section Dynamically
function updateHero(movie) {
  currentMovie = movie; // Store current movie
...
trailerBtn.addEventListener("click", () => {
  ...
  // Update trailer popup with current movie data
  document.getElementById("trailer-title").textContent = currentMovie.title;
  document.getElementById("trailer-description").textContent = currentMovie.description;
  document.getElementById("trailer-rating").textContent = currentMovie.rating;
  document.getElementById("trailer-genre").textContent = currentMovie.genre;
  document.getElementById("trailer-year").textContent = currentMovie.year;
  document.getElementById("trailer-cast").textContent = currentMovie.cast.join(", ");

  // Set YouTube embed with trailer ID
  if (currentMovie.youtubeId) {
    trailerVideo.src = `https://www.youtube.com/embed/${currentMovie.youtubeId}?autoplay=1&mute=1&rel=0&modestbranding=1`;
  } else {
...
// Close trailer when clicking outside the popup box
